							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除" onclick="checked()"><i
									...
									<c:forEach items="${pageInfo.list}" var="product">
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/product/updateById.do?id=${product.id}'">状态改变</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
...
<script>
	...
	<script>
		...
		var checked = function(){
			...
			location.href = "${pageContext.request.contextPath}/product/deleteProductById.do?ids=" + checkData;
		};
	</script>
