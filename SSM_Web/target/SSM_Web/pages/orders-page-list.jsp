...
<%--										</button>--%>
										<button type="button" class="btn btn-default" title="删除" onclick="checked()">
...
<%--&lt;%&ndash;												<button type="button" class="btn bg-olive btn-xs">订单</button>&ndash;%&gt;--%>
<%--												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findById.do?id=${orders.id}'">详情</button>--%>
<%--&lt;%&ndash;												<button type="button" class="btn bg-olive btn-xs">删除</button>&ndash;%&gt;--%>
<%--											</td>--%>
<%--										</tr>--%>
...
<%--                            总共2 页，共14 条数据。 每页--%>
	...
	<script>
		...
		var checked = function(){
			...
			location.href = "${pageContext.request.contextPath}/orders/deleteOrder.do?ids=" + checkData;
		};
	</script>
